...
const ProductPage = (() => {
  ...
  function renderProduct() {
    ...
    const shareFbUrl = encodeURIComponent(shareProductUrl);
    const shareXUrl = encodeURIComponent(shareProductUrl);
    const shareXText = encodeURIComponent(
      `${product.name} by ${product.brand} — check it out on Kicksy Nepal 👟`,
    );
      ...
      <div class="product-info">
        ...
        <div class="product-share" id="productShare" aria-label="Share this product">
          ...
          <div class="product-share-btns">
            ...
            <a class="product-share-btn product-share-fb"
               href="https://www.facebook.com/sharer/sharer.php?u=${shareFbUrl}"
               target="_blank" rel="noopener noreferrer"
            ...
            <a class="product-share-btn product-share-x"
               href="https://x.com/intent/tweet?url=${shareXUrl}&text=${shareXText}"
               target="_blank" rel="noopener noreferrer"
               aria-label="Share on X / Twitter">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              <span>X</span>
            </a>
